...
export const REPAIRS: RepairGuide[] = [
  ...
  {
    slug: "fix-ice-maker-not-making-ice",
    title: "How to Fix an Ice Maker That's Not Making Ice",
    metaDescription: "Ice maker not working? Fix it in under an hour. Diagnose frozen fill tubes, clogged water filters, bad water valves, and arm/switch issues. Avoid a $200 service call.",
    heroEmoji: "🧊",
    difficulty: "Easy",
    activeTime: 25,
    totalTime: 45,
