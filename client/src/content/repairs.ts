...
export const REPAIRS: RepairGuide[] = [
  ...
  {
    slug: "fix-water-heater-no-hot-water",
    title: "How to Troubleshoot a Water Heater With No Hot Water",
    metaDescription: "No hot water? Step-by-step guide to diagnose and fix your water heater. Check the pilot light, thermostat, and heating element before calling a plumber.",
    heroEmoji: "🔥",
    difficulty: "Medium",
    activeTime: 45,
    totalTime: 90,
    estimatedCost: "$0-30",
    safetyLevel: "Advanced repair",
    overview: "Waking up to a cold shower is one of the most stressful household surprises, especially if you have no idea why your water heater stopped working. Before you panic and call a plumber for an emergency visit ($150-300+), the problem is often something you can diagnose and fix yourself in under an hour.\n\nWater heaters — both gas and electric — fail for a handful of predictable reasons. On gas units, the pilot light goes out, the thermocouple fails, or the gas valve malfunctions. On electric units, a tripped breaker, a failed heating element, or a bad thermostat is usually the culprit. In most cases, the fix costs under $30 in parts and requires only basic tools.\n\nThis guide walks you through a systematic check for both gas and electric water heaters, starting with the simplest causes and working toward the less common ones. Even if you ultimately decide to call a professional, knowing exactly what is wrong will help you avoid getting overcharged and will usually mean a faster repair.",
    toolsNeeded: ["Multimeter", "Flathead screwdriver", "Phillips screwdriver", "Non-contact voltage tester", "Garden hose (for draining if needed)"],
    materialsNeeded: [
      { name: "Water heater thermocouple (gas)", estimatedCost: "$8-15", amazonSearch: "universal+water+heater+thermocouple" },
      { name: "Electric water heater element", estimatedCost: "$10-20", amazonSearch: "electric+water+heater+element+universal" },
      { name: "Water heater thermostat", estimatedCost: "$10-18", amazonSearch: "electric+water+heater+thermostat" },
    ],
    steps: [
      {
        title: "Check the obvious stuff first",
        description: "Before touching the water heater, check your breaker panel. A tripped breaker is the #1 cause of no hot water on electric units — just flip it back. For gas units, make sure the gas valve is in the ON position (parallel to the gas line). Also check if other gas appliances work — if nothing works, the issue may be your gas supply, not the water heater.",
      },
      {
        title: "Check the pilot light (gas units)",
        description: "Look through the small window at the bottom of your gas water heater. You should see a small blue flame — that is the pilot light. If it is out, follow the relighting instructions on the label (usually: turn the knob to PILOT, press and hold the igniter button for 30-60 seconds, then release). If the pilot lights but goes out when you release the button, the thermocouple is likely bad.",
        safetyWarning: "If you smell gas (rotten egg odor), do NOT attempt to relight. Leave the house immediately and call your gas company.",
      },
      {
        title: "Test the thermocouple (gas units)",
        description: "The thermocouple is a thin metal rod that sits in the pilot flame. It is a safety device that shuts off gas if the pilot goes out. Over time it wears out. If your pilot lights but will not stay lit, replace the thermocouple. Unscrew it from the gas valve (one nut), pull it out, and take it to the hardware store for an exact match. Installation is the reverse — thread it in, tighten snugly, and relight the pilot.",
      },
      {
        title: "Check the thermostat setting",
        description: "On gas units, the temperature dial is on the gas valve — it should be set to about 120°F. On electric units, turn off the breaker first, then remove the access panels on the side of the tank (usually upper and lower). Behind the insulation you will find the thermostats. They should be set to 120°F. Press the red reset button on the upper thermostat — if it clicks, that may have been the problem. Restore power and wait 1-2 hours.",
        safetyWarning: "Always turn off power at the breaker before removing access panels on electric water heaters. There is 240V inside.",
      },
      {
        title: "Test the heating elements (electric units)",
        description: "With power OFF at the breaker, use a multimeter set to continuity or resistance. Disconnect one wire from the element terminal. Touch one probe to each terminal screw on the element. A good element reads 10-16 ohms. An open circuit (no reading) means the element is burned out and needs replacing. Most electric water heaters have two elements — test both.",
      },
      {
        title: "Replace a failed element (electric units)",
        description: "Turn off the breaker and confirm power is off with a non-contact voltage tester. Close the cold water inlet valve and connect a garden hose to the drain valve at the bottom. Drain the tank below the element level. Unscrew the old element with an element wrench (a large socket). Apply Teflon tape to the threads of the new element, screw it in, and tighten firmly. Refill the tank BEFORE restoring power — running an element dry will burn it out instantly.",
        safetyWarning: "Never turn on power to an electric water heater until the tank is completely full of water.",
      },
      {
        title: "Wait and verify",
        description: "After any repair, give the water heater 30-60 minutes to heat up. Run hot water at the farthest faucet from the heater. It should gradually get hot. If you still have no hot water after checking all of the above, the issue may be a failed gas valve or a cracked dip tube — both are pro-level repairs.",
      },
    ],
    whenToCallPro: "Call a plumber or HVAC technician if you smell gas and cannot locate the source, if the gas valve itself appears to be leaking or malfunctioning, if you are not comfortable working with 240V electrical connections, if the tank is visibly leaking from the bottom (this means the tank has corroded through and the entire unit needs replacing), or if the water heater is more than 10-12 years old and failing — replacement is usually more cost-effective than repair at that point.",
    relatedRepairs: ["fix-running-toilet", "fix-leaky-faucet", "unclog-drain"],
  },
  {
    slug: "fix-clogged-toilet",
    title: "How to Unclog a Toilet Without Calling a Plumber",
    metaDescription: "Clogged toilet? Step-by-step guide to unclog it fast using a plunger, auger, or household items. Save $100-250 on a plumber visit.",
    heroEmoji: "🪠",
    difficulty: "Easy",
    activeTime: 15,
    totalTime: 30,
    estimatedCost: "$0-25",
    safetyLevel: "DIY-friendly",
    overview: "A clogged toilet is arguably the most panic-inducing home repair, especially when the water is rising and you have guests over. Take a deep breath — in the vast majority of cases, you can clear a clogged toilet yourself in under 15 minutes with nothing more than a plunger.\n\nMost toilet clogs happen in the trap — the curved section built into the porcelain at the base of the toilet. Toilet paper, waste, or sometimes a child's toy gets stuck there and blocks the flow. A proper plunging technique clears about 90% of these clogs. For the stubborn remaining 10%, a toilet auger (also called a closet auger) can reach deeper into the drain.\n\nThe key to success is having the right plunger — not the flat red cup kind (that is for sinks), but a flange plunger with an extended rubber lip that seals into the toilet drain. This guide covers the right technique for both plungers and augers, plus a couple of no-tool tricks that work surprisingly well for minor clogs.",
    toolsNeeded: ["Flange plunger", "Toilet auger / closet auger (for stubborn clogs)", "Rubber gloves", "Old towels", "Bucket"],
    materialsNeeded: [
      { name: "Flange plunger", estimatedCost: "$8-15", amazonSearch: "toilet+flange+plunger" },
      { name: "Toilet auger / closet auger", estimatedCost: "$15-25", amazonSearch: "toilet+auger+closet+auger" },
      { name: "Rubber gloves (heavy duty)", estimatedCost: "$5-8", amazonSearch: "heavy+duty+rubber+gloves+cleaning" },
    ],
    steps: [
      {
        title: "Stop the water from rising",
        description: "If the bowl is filling up and looks like it might overflow, act fast. Reach behind the toilet and turn the shut-off valve clockwise until it stops. If you cannot find the valve or it is stuck, lift the tank lid and push the flapper (the rubber disc at the bottom of the tank) down to stop water from entering the bowl. Then lift the float ball or float cup to stop the tank from refilling.",
      },
      {
        title: "Try hot water and dish soap first (minor clogs)",
        description: "For a soft clog (too much toilet paper), this often works without any tools. Squirt a generous amount of dish soap into the bowl. Then carefully pour a bucket of hot (not boiling) water from waist height into the bowl. The soap lubricates and the hot water helps dissolve the clog. Wait 10-15 minutes, then try flushing. If the water drains slowly, repeat once more before moving to the plunger.",
      },
      {
        title: "Plunge with proper technique",
        description: "Use a flange plunger — it has an extra rubber lip that folds out from inside the cup, creating a seal in the toilet drain opening. Submerge the plunger in the water so the cup fills (you need water, not air, to create pressure). Place the flange into the drain hole and push down gently to create a seal. Then push and pull vigorously 15-20 times, keeping the seal tight. The pull stroke is just as important as the push — it creates suction that breaks up the clog. After a set of plunges, break the seal by pulling the plunger away. If the water rushes down, you are done.",
      },
      {
        title: "Use a toilet auger for stubborn clogs",
        description: "If plunging does not work after 3-4 attempts, use a toilet auger. Insert the rubber-coated end into the drain opening. Crank the handle clockwise while pushing the cable forward. You will feel resistance when you hit the clog. Keep cranking — the auger tip will either break through the clog or hook onto it. Pull the auger back slowly. You may need to repeat this 2-3 times. Flush to test.",
      },
      {
        title: "Clean up and test",
        description: "Once the clog clears, flush the toilet 2-3 times to make sure water flows freely. Turn the shut-off valve back on if you closed it. Clean the plunger or auger with hot water and a disinfectant. Wipe down any splashes around the toilet base. Wash your hands thoroughly.",
      },
    ],
    whenToCallPro: "Call a plumber if the auger does not clear the clog after several attempts (the blockage may be further down the main drain line), if multiple fixtures in your home are draining slowly or backing up (this indicates a main sewer line problem, not just a toilet clog), if you see sewage backing up into a tub or shower when you flush, or if this is a recurring problem — repeated clogs in the same toilet may mean a partially collapsed pipe or root intrusion in the sewer line.",
    relatedRepairs: ["fix-running-toilet", "unclog-drain", "replace-toilet-flapper"],
  },
  {
    slug: "fix-leaky-pipe-under-sink",
    title: "How to Fix a Leaky Pipe Under the Sink",
    metaDescription: "Leaky pipe under your sink? Step-by-step guide to fix compression fittings, replace the P-trap, and stop the drip. Most fixes cost under $15.",
    heroEmoji: "🔧",
    difficulty: "Easy",
    activeTime: 30,
    totalTime: 45,
    estimatedCost: "$5-20",
    safetyLevel: "DIY-friendly",
    overview: "Finding a puddle under your sink is alarming, but under-sink leaks are one of the most common and most fixable plumbing problems homeowners face. In most cases, the leak is coming from one of three places: a loose compression fitting on a supply line, a worn-out washer or gasket in the P-trap (the curved pipe section), or a cracked drain tailpiece.\n\nThe good news is that almost all under-sink plumbing uses hand-tight slip-joint connections — no soldering, no glue, and no special tools beyond a pair of pliers and a bucket. You can usually fix the leak in 20-30 minutes for under $15 in parts.\n\nThe most important first step is figuring out exactly where the water is coming from. Many people assume the worst, but most under-sink leaks are just a loose nut that needs a quarter turn. This guide will help you pinpoint the source and fix it with confidence.",
    toolsNeeded: ["Adjustable pliers or channel-lock pliers", "Bucket", "Flashlight", "Old towels or rags", "Plumber's tape (Teflon tape)"],
    materialsNeeded: [
      { name: "P-trap kit (1-1/4\" or 1-1/2\")", estimatedCost: "$5-12", amazonSearch: "p+trap+kit+kitchen+sink" },
      { name: "Slip joint washers assortment", estimatedCost: "$3-6", amazonSearch: "slip+joint+washers+assortment+plumbing" },
      { name: "Plumber's tape (Teflon)", estimatedCost: "$2-4", amazonSearch: "plumbers+teflon+tape" },
    ],
    steps: [
      {
        title: "Find the leak source",
        description: "Clear everything out from under the sink. Place a dry paper towel or old towel under the pipes. Run the water and use a flashlight to trace exactly where the drip originates. Check these spots in order: the supply line connections (where the flexible hoses connect to the shut-off valves and the faucet), the drain tailpiece (the straight pipe coming down from the sink drain), the slip-joint nuts on the P-trap (the U-shaped curved pipe), and the connection where the P-trap meets the wall pipe. Mark the wet spot with a piece of tape.",
      },
      {
        title: "Tighten the connection (simplest fix)",
        description: "Most under-sink leaks are just a loose slip-joint nut. With the water running, use channel-lock pliers to gently tighten the nut at the leak point — turn clockwise about a quarter turn. Do not overtighten plastic nuts (they crack). If the leak stops, you are done. If it slows but does not stop, the washer inside the connection is likely worn.",
      },
      {
        title: "Replace the washer or gasket",
        description: "Place a bucket under the P-trap. Loosen the slip-joint nut at the leaking connection by turning counter-clockwise. Pull the pipe apart gently. Inside the connection you will see a rubber or nylon washer (beveled or flat). Take the old washer to the hardware store for an exact size match. Slip the new washer onto the pipe with the beveled side facing the nut, reassemble, and hand-tighten the nut plus a quarter turn with pliers. Run water and check for drips.",
      },
      {
        title: "Replace the P-trap if it is cracked or corroded",
        description: "If the P-trap itself is cracked, corroded (common with old chrome traps), or the threads are stripped, replace the whole thing. Loosen both slip-joint nuts, remove the trap, and take it to the store. Buy a PVC replacement kit in the same diameter (1-1/4\" for bathroom sinks, 1-1/2\" for kitchen sinks). Install the new trap with the included washers, hand-tighten the nuts, then give each a quarter turn with pliers. Run water for a full minute and check every connection.",
      },
      {
        title: "Fix a supply line leak",
        description: "If the leak is at a supply line connection (the braided hose going to the faucet or to the shut-off valve), turn off the shut-off valve first. Unscrew the supply line fitting, check the rubber washer inside for cracks or deformation, and replace if needed. Wrap the threads with 2-3 layers of Teflon tape before reconnecting. Tighten firmly but do not overtorque — supply line fittings are compression style and only need to be snug.",
      },
      {
        title: "Test and dry out the cabinet",
        description: "After making your repair, run the water at full blast for 2-3 minutes. Check every connection with the flashlight. If everything is dry, wipe out the cabinet thoroughly and let it air out for a day. If you see any signs of mold or mildew from the previous leak, spray with a 50/50 vinegar-water solution and let it dry completely before putting anything back under the sink.",
      },
    ],
    whenToCallPro: "Call a plumber if the leak is coming from the shut-off valve itself (the valve may need replacement, which requires shutting off the main water supply), if you find corroded or damaged pipes inside the wall, if the pipe connection to the wall drain is loose or damaged (this may involve ABS/PVC cement or even in-wall work), or if the leak persists after replacing the obvious washers and connections — there may be a hairline crack in the tailpiece or a defective faucet drain body.",
    relatedRepairs: ["fix-leaky-faucet", "fix-dripping-kitchen-faucet", "unclog-drain"],
  },
  {
    slug: "fix-sticking-door",
    title: "How to Fix a Door That Sticks or Won't Close",
    metaDescription: "Door sticking or won't close? Step-by-step guide to diagnose and fix sticking doors. Adjust hinges, plane edges, or fix the strike plate in under an hour.",
    heroEmoji: "🚪",
    difficulty: "Easy",
    activeTime: 30,
    totalTime: 45,
    estimatedCost: "$0-15",
    safetyLevel: "DIY-friendly",
    overview: "A sticking door is one of those annoying problems that gets worse over time until you finally cannot close it without a full-body slam. It is also one of the easiest and most satisfying repairs you can do — most sticking doors can be fixed in 15-30 minutes without removing the door.\n\nDoors stick for a few predictable reasons: the hinges have loosened over time (causing the door to sag), humidity has caused the wood to swell, the house has settled slightly and shifted the door frame, or the strike plate no longer lines up with the latch. Each cause has a different fix, but all of them are straightforward.\n\nBefore you reach for a plane or sandpaper, start with the hinges — they are the most common culprit and the easiest fix. Tightening or shimming the hinges solves the problem about 60% of the time with zero woodworking required. This guide starts with the simplest fixes and works up to the ones that require a bit more effort.",
    toolsNeeded: ["Phillips screwdriver", "3-inch wood screws", "Hammer", "Wooden toothpicks or golf tees", "Block plane or hand sander", "Chisel (if adjusting strike plate)", "Pencil", "Lipstick or chalk (for marking contact points)"],
    materialsNeeded: [
      { name: "3-inch wood screws (for hinge repair)", estimatedCost: "$3-5", amazonSearch: "3+inch+wood+screws+door+hinge" },
      { name: "Door hinge shims", estimatedCost: "$3-5", amazonSearch: "door+hinge+shims+cardboard" },
      { name: "Block plane (if you don't have one)", estimatedCost: "$12-20", amazonSearch: "small+block+plane+woodworking" },
    ],
    steps: [
      {
        title: "Find exactly where the door sticks",
        description: "Close the door slowly and watch where it first makes contact with the frame. If it is not obvious, rub a piece of chalk or lipstick on the door edge, then close the door. The chalk will transfer to the spot on the frame (or vice versa) where the door is binding. Common spots: top corner on the latch side (sagging), along the entire latch side (swelling), or bottom edge (settling).",
      },
      {
        title: "Tighten the hinge screws (the 60% fix)",
        description: "Open the door and tighten every screw in the top hinge — both the door side and the frame side. Loose hinge screws are the most common cause of sagging doors. If a screw spins freely and will not tighten (the hole is stripped), remove the screw, stuff the hole with wooden toothpicks or a golf tee dipped in wood glue, snap off the excess, let it dry for 30 minutes, then drive the screw back in. This gives the screw fresh wood to grip.",
      },
      {
        title: "Drive a long screw into the frame (for sagging)",
        description: "If the door sags and tightening did not help, the frame-side top hinge needs a stronger anchor. Remove the center screw on the frame side of the top hinge and replace it with a 3-inch wood screw. This longer screw will reach through the jamb and into the wall stud behind it, pulling the top of the frame slightly toward the wall and lifting the door. This is often the single most effective fix for a sagging door.",
      },
      {
        title: "Shim the hinges (for binding along the full edge)",
        description: "If the door binds along the entire latch-side edge, the hinges may be set too deep into the frame. Remove the hinge from the frame side (leave the door-side in place), cut a piece of thin cardboard the exact size of the hinge mortise, place it in the mortise, and re-mount the hinge on top of it. This pushes the door slightly away from the frame on the hinge side, creating more clearance on the latch side.",
      },
      {
        title: "Plane or sand the high spot",
        description: "If the door is binding because the wood has swelled (common in humid climates), you may need to remove a small amount of material. Mark the high spot with pencil. If it is on the top edge, you can plane it without removing the door — open the door fully and plane toward the center of the door, not off the edge. If the high spot is on the latch-side edge, you may need to remove the door. Take off only a little at a time — a few passes with a block plane or 80-grit sandpaper. Test the fit frequently. Prime and paint the exposed wood to prevent future swelling.",
      },
      {
        title: "Adjust the strike plate (if the latch does not catch)",
        description: "If the door closes but the latch does not click into the strike plate, the plate has shifted. Close the door and observe where the latch hits relative to the strike plate opening. If it is off by less than 1/8 inch, you can file the strike plate opening with a small metal file. If it is off by more, remove the strike plate, chisel the mortise slightly in the needed direction, reposition the plate, and secure it. Fill the old screw holes with toothpicks and glue first so the screws have fresh wood to bite.",
      },
    ],
    whenToCallPro: "Call a carpenter or handyman if the door frame itself is visibly twisted or out of square (this can indicate a structural settling issue), if the door is a solid-core door that is too heavy for you to remove and rehang safely, if the sticking is caused by significant foundation movement (cracks in walls, multiple doors sticking, gaps appearing in trim), or if the door frame needs to be removed and reinstalled.",
    relatedRepairs: ["fix-squeaky-door", "mount-tv-on-wall", "patch-drywall-hole"],
  },
  {
    slug: "replace-toilet-seat",
    title: "How to Replace a Toilet Seat",
    metaDescription: "Replace a toilet seat in 15 minutes. Step-by-step guide to measuring, removing the old seat, and installing the new one. Easiest home repair you'll ever do.",
    heroEmoji: "🪑",
    difficulty: "Easy",
    activeTime: 10,
    totalTime: 15,
    estimatedCost: "$15-50",
    safetyLevel: "DIY-friendly",
    overview: "Replacing a toilet seat is genuinely one of the easiest home repairs that exists — it requires no plumbing knowledge, no special tools, and takes about 10-15 minutes from start to finish. If you have never fixed anything in your home before, this is a great confidence builder.\n\nToilet seats wear out, crack, get stained beyond cleaning, or you might just want an upgrade (heated seats and soft-close lids are game changers). Whatever the reason, the process is the same: measure your toilet to get the right size seat, unscrew the old one, and bolt on the new one.\n\nThe only tricky part is sometimes the old bolts are rusted or corroded and do not want to come off. This guide covers that scenario too, with a couple of tricks that work every time. By the end, you will have a fresh, tight-fitting toilet seat and the satisfaction of knowing you did not pay someone $100 to do a 10-minute job.",
    toolsNeeded: ["Adjustable wrench or pliers", "Flathead screwdriver", "Penetrating oil (like WD-40, if bolts are stuck)", "Tape measure"],
    materialsNeeded: [
      { name: "Replacement toilet seat (round or elongated)", estimatedCost: "$15-45", amazonSearch: "toilet+seat+replacement+soft+close" },
      { name: "Toilet seat bolt kit (if bolts are damaged)", estimatedCost: "$5-8", amazonSearch: "toilet+seat+bolt+kit+universal" },
    ],
    steps: [
      {
        title: "Measure your toilet to get the right seat",
        description: "Toilet bowls come in two shapes: round (about 16.5 inches from the front of the bowl to the center of the mounting bolts) and elongated (about 18.5 inches). Measure from the center of the bolt holes to the front edge of the bowl. If it is 16-17 inches, you need a round seat. If it is 18-19 inches, you need an elongated seat. The bolt holes are always spaced 5.5 inches apart (this is standard). Buy the matching shape — a round seat will not fit an elongated bowl properly, and vice versa.",
      },
      {
        title: "Remove the old toilet seat",
        description: "Open the bolt caps at the back of the seat (they are usually plastic covers that flip up or pop off). Underneath you will see a bolt head (plastic or metal). Hold the nut on the underside of the toilet with pliers or your hand, and unscrew the bolt from the top with a screwdriver. If the bolts are plastic, this should be easy. If they are metal and rusted, spray penetrating oil (WD-40) on the nuts, wait 10 minutes, and try again.",
      },
      {
        title: "Deal with stuck or corroded bolts",
        description: "If the nuts are completely corroded and will not budge even with penetrating oil, use a hacksaw blade (just the blade, no frame) to saw through the bolt between the toilet and the nut. Alternatively, use a pair of locking pliers on the nut and a screwdriver on the bolt and apply steady pressure. Worst case, a reciprocating saw or oscillating multi-tool with a metal-cutting blade will cut through in seconds. Do not force it with brute strength — you can crack the porcelain.",
        safetyWarning: "Be careful not to scratch or chip the porcelain when cutting or prying stuck bolts. Cracked porcelain cannot be repaired.",
      },
      {
        title: "Clean the mounting area",
        description: "With the old seat removed, clean the top of the toilet around the bolt holes. There is usually a buildup of grime, old caulk, or mineral deposits. Use a bathroom cleaner or a paste of baking soda and water with an old toothbrush. Dry the area completely. This is also a good time to clean the parts of the toilet bowl rim that are normally hidden under the seat.",
      },
      {
        title: "Install the new toilet seat",
        description: "Place the new seat on the toilet, lining up the mounting holes. Most modern toilet seats come with plastic bolts and wing nuts — thread the bolts down through the holes from the top, then hand-tighten the wing nuts from the underside. Some seats have a top-tightening system where you just tighten from above with a screwdriver. Alternate tightening between the two bolts so the seat stays centered. Tighten until snug — do not overtighten plastic bolts or they will snap.",
      },
      {
        title: "Test the fit and adjust",
        description: "Sit on the seat and shift your weight gently. The seat should not slide or wobble. If it shifts, tighten the bolts a bit more. Close the lid — if you got a soft-close seat, it should lower smoothly without slamming. Some soft-close seats have adjustment knobs on the hinges for fine-tuning the closing speed. Open and close it a few times to make sure everything moves freely.",
      },
    ],
    whenToCallPro: "This is one repair where you almost never need a pro. The only exception would be if the porcelain around the bolt holes is cracked or chipped so badly that the new seat cannot mount securely — in that case, the toilet itself may need to be replaced, which is a bigger job involving disconnecting the water supply and the wax ring seal at the floor.",
    relatedRepairs: ["fix-running-toilet", "replace-toilet-flapper", "stop-toilet-running-after-flush"],
  },
];
