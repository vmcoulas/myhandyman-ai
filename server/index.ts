...
(async () => {
  // Auth must be set up before routes so session/passport middleware is ready
  await setupAuth(app);
  ...
  // Use PORT env var for deployment platforms (Railway, Render, etc.), fallback to 5000 for local dev
